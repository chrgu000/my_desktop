...
if __name__ =="__main__":
    frozenset()
    QueueManager.register("get_task_queue",callable=get_task) #任务队列
    QueueManager.register("get_result_queue",callable=get_result)#结果队列

    manager=QueueManager(address=("127.0.0.1",55000),authkey=b"123456") #服务器密码
